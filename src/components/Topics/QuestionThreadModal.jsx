        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6 space-y-4">
            ...
            <div className="flex gap-3">
              <div className="w-8 h-8 bg-primary-600 rounded-full flex items-center justify-center flex-shrink-0 text-white text-sm font-semibold">
                T
              </div>
            ...
            <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-600 focus:border-transparent text-sm"
                />
                <button
                  onClick={handleReply}
                  disabled={!replyMessage.trim() || isSubmitting}
                  className="px-5 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-primary-600 flex items-center gap-2"
                >
