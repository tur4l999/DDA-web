...
function ArticleAccordion({ title, children, defaultOpen = false }) {
...
export default function ArticlesContent() {
  return (
    <div className="max-w-4xl mx-auto space-y-4">
      <ArticleAccordion title="Maddə 1. Əsas anlayışlar" defaultOpen={true}>
      ...
      <ArticleAccordion title="Maddə 2. Sürücülük vəsiqəsi">
         <div className="p-6 sm:p-8 text-gray-800 leading-relaxed">
            <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Bu maddə üzərində iş gedir</h3>
                <p className="text-gray-500 max-w-sm">
                    Bu maddənin mətni tezliklə əlavə olunacaq.
                </p>
            </div>
         </div>
      </ArticleAccordion>
