              ...
              {packages.map((pkg, index) => (
                <div
                  ...
                  className={`relative rounded-2xl border-2 p-6 transition-all hover:shadow-xl ${
                    pkg.popular
                      ? 'border-primary-600 bg-gradient-to-br from-primary-600/5 to-transparent'
                      : 'border-gray-200 hover:border-primary-600/30'
                  }`}
                >
                  {pkg.popular && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-4 py-1 rounded-full text-xs font-bold flex items-center gap-1 shadow-lg">
