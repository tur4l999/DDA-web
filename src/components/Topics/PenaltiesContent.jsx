      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-600/20 focus:border-primary-600 text-sm"
          />
        </div>
      </div>
      ...
      <div className="space-y-3">
        {filteredPenalties.map(penalty => {
          ...
          return (
            <div
              key={penalty.id}
              className="bg-white border border-gray-200 rounded-xl hover:shadow-lg hover:border-primary-600 transition-all"
            >
              <div className="p-4">
                <div className="flex items-start gap-4">
                  ...
                  {penalty.hasVideo && (
                    <button
                      ...
                      className="group w-36 flex-shrink-0 bg-gray-100 rounded-lg overflow-hidden hover:ring-2 hover:ring-primary-600 transition-all"
                    >
