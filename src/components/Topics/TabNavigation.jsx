...
export default function TabNavigation({ activeTab, onTabChange, onExamClick, onContactClick, userPackage = 'basic', onPaywallOpen }) {
  return (
    <div className="sticky top-[68px] z-20 bg-white border-b border-gray-100/50 shadow-sm">
      <div className="px-4 lg:px-8 py-2">
        <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide py-1">
              ...
              return (
                <div key={tab.id} className="relative group">
                  <button
                    ...
                    className={`flex items-center gap-2 px-3.5 py-2 text-xs font-semibold whitespace-nowrap transition-all rounded-xl ${
                  ...
                  {/* Tooltip */}
                  {isLocked && (
                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 bg-gray-900 text-white text-xs font-medium rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-xl">
                      Paket tələb olunur
          ...
          <button
            onClick={onExamClick}
            className="flex items-center gap-2 px-5 py-2.5 bg-primary-500 hover:bg-primary-600 text-white text-xs font-bold rounded-xl transition-all whitespace-nowrap shadow-lg shadow-primary-500/20 hover:shadow-primary-500/40 active:scale-95"
          >
