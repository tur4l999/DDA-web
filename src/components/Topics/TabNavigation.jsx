    ...
    <div className="sticky top-[57px] z-20 bg-white border-b border-gray-200 shadow-sm">
      <div className="px-4 lg:px-6 py-1.5">
        <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide">
          ...
          <button
            onClick={onExamClick}
            className="flex items-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white text-xs font-semibold rounded-lg transition-colors whitespace-nowrap shadow-sm"
          >
