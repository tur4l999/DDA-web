          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-600/20 focus:border-primary-600 resize-none"
              />
            </div>
            ...
            <div>
              ...
              {!imagePreview ? (
                <div 
                  ...
                  className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-primary-600 hover:bg-primary-600/5 transition-all cursor-pointer"
                >
