  ...
  return (
    <div className="bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 rounded-xl shadow-lg p-4 text-white border border-white/20 overflow-hidden relative h-full">
      ...
      <div className="relative flex flex-col items-center text-center">
        {/* Avatar */}
        <div className="w-14 h-14 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center mb-2 ring-2 ring-white/30 shadow-lg">
        ...
        <div className="flex items-center gap-1 text-green-100 text-xs mb-3">
          <MapPin className="w-3 h-3" strokeWidth={2} />
          <span>Test Academy</span>
        </div>

        {/* Primary CTA */}
        <button className="w-full bg-white hover:bg-gray-50 text-primary-700 font-semibold py-2 px-4 rounded-lg transition-all duration-200 text-xs shadow-lg hover:shadow-xl flex items-center justify-center gap-1.5">
