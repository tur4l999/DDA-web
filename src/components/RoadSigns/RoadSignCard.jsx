...
import { ChevronDown, AlertCircle, Maximize2 } from 'lucide-react'
  ...
  return (
    <>
      <div
        ...
        className={`bg-white rounded-2xl border transition-all cursor-pointer overflow-hidden relative ${
          isExpanded
      ...
      >
        ...
        {/* Expanded Details */}
        {isExpanded && (
          <div className="px-4 pb-4 pt-0 space-y-3 text-left animate-slide-up border-t border-gray-100 mt-2 relative">
             <div className="pt-3">
             ...
             <button
               ...
               className="w-full mt-2 py-2.5 text-xs font-bold text-primary-700 bg-primary-50 hover:bg-primary-100 rounded-xl transition-all flex items-center justify-center gap-2 group"
             >
