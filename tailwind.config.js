...
export default {
  ...
  theme: {
    extend: {
      /* ─────────────────────────────────────────
         COLOR SYSTEM
         Modern, calming palette with teal as primary
         ───────────────────────────────────────── */
      colors: {
        // Primary - Teal (sophisticated green alternative)
        primary: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
      ...
      boxShadow: {
        ...
        'card-hover': '0 10px 40px -10px rgb(15 118 110 / 0.12)',
        'none': 'none',
      },
